...
export default function LiveMonitoringPage() {
  const loader = useCallback((signal: AbortSignal, mode: "dummy" | "live") => getLiveMonitoringData(signal, mode), []);
  const resource = useRamsResource<LiveMonitoringData>(loader, 10_000);
  ...
  return <LiveMonitoringWorkspace points={resource.data.points} trainsets={resource.data.trainsets} isDummy={resource.source === "dummy"} />;
}
